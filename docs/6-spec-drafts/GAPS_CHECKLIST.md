...
| # | Gap | Status | Audit | Draft | Canonical Target |
|---|-----|--------|-------|-------|-----------------|
| T3-01 | **Projectile Simulation** — Core mechanics exist. Needs reconciliation with `P-07` and `P-61` primitives for dynamic properties and bouncing. | `DRAFTING` | Supported by Game Compiler taxonomy. | [draft](tier-3-subsystems/01-projectile-simulation.md) | `3-gameplay-systems/02-ability-framework.md` |
...
| T3-03 | **Zone Actor Pulse Mechanics** — Core pulse model exists. Needs reconciliation with `P-14 Continuous Proximity Monitor` for edge-triggered events. | `DRAFTING` | Supported by Game Compiler taxonomy. | [draft](tier-3-subsystems/03-zone-actor-pulse-mechanics.md) | `3-gameplay-systems/02-ability-framework.md` + `03-global-events.md` |
...
| 1 — Combat | 6 | 3 | 1 | 2 | 0 | 0 |
| 2 — Contracts | 8 | 2 | 1 | 0 | 4 | 1 |
| 3 — Subsystems | 10 | 7 | 2 | 0 | 1 | 0 |
