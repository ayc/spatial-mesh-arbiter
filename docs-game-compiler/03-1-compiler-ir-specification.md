...
Any combat event generated by a PostDamage hook (P-35, P-36, P-37, P-38, P-60) MUST be queued for the NEXT tick's PreMitigation stage. It MUST NOT re-enter the current tick's combat pipeline.

Similarly, Pulse Timer (P-44) and Delay Timer (P-45) payloads that fire during StateUpdate MUST be queued for the next tick.
